...
def do_edits():
    ...
    pats = [
        ...
        (r"Union[int, float, complex, str, bytes, numpy.generic, Sequence[Union[int, float, complex, str, bytes, numpy.generic]], Sequence[Sequence[Any]], numpy.typing._array_like._SupportsArray]", "ArrayLike"),
